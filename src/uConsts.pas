(* C2PP
  ...
  ***************************************************************************
  File last update : 2025-07-11T13:13:28.000+02:00
  Signature : 7fa83e0828a118fa21aa40cebd7bbea2e1969fb6
  ***************************************************************************
*)
...
const
  ...
  /// </summary>
  CSupportURL =
    'https://lognpass.olfsoftware.fr/contact/';
...
{$ELSE}
// TODO : prendre en charge distinction Store / Direct pour Windows et Mac sur les mises à jour via CilTseg
  CUsedProgramUpdatesManager = TProgramUpdatesManagers.None; //CilTseg;
  {$ENDIF}
