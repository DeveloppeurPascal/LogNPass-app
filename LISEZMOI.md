...
* [DeveloppeurPascal/LogNPass4Delphi](https://github.com/DeveloppeurPascal/LogNPass4Delphi) doit être installé dans le sous dossier ./lib-externes/LogNPass4Delphi
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://lognpass.olfsoftware.fr).
